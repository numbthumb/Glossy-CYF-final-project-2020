...
INSERT INTO terms (term, definitions, links, admin_id, programming_language, contributor_id) VALUES ('Body','The body is the container for all of a page’s content. Comes after the <head> tag, within the overall <html> tag.', '{"https://www.youtube.com/watch?v=RgwEVLoExGQ", "https://www.youtube.com/watch?v=RgwEVLoExGQ", "https://www.youtube.com/watch?v=mNRzWMH5xK0", "https://www.w3schools.com/tags/tag_body.asp", "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/body"}', 2,'HTML', 1);
...
INSERT INTO terms (term, definitions, links, admin_id, programming_language, contributor_id) VALUES ('Variables','JavaScript variables are containers for storing data values.', '{"https://www.youtube.com/watch?v=edlFjlzxkSI", "https://www.youtube.com/watch?v=u0Mq3FzpsmI", "https://www.w3schools.com/js/js_variables.asp", "https://developer.mozilla.org/en-US/docs/Glossary/Variable"}',1,'Javascript',2);
